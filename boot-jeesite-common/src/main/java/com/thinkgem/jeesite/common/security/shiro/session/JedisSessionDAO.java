...
public class JedisSessionDAO extends AbstractSessionDAO implements SessionDAO,InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        setSessionIdGenerator(new IdGen());
        setSessionKeyPrefix("jeesite_session_");
...
//            // 如果是视图文件，则不更新SESSION
//            if (StringUtils.startsWith(uri, Global.getConfig("controller.view.prefix"))
//                    && StringUtils.endsWith(uri, Global.getConfig("controller.view.suffix"))){
//                return;
//            }
            // 手动控制不更新SESSION
