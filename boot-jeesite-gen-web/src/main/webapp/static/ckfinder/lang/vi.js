...
CKFinder.lang['vi'] =
{
	...
	ErrorMsg :
	{
		...
		PopupBlockView	: 'Không thể mở tập tin trong cửa sổ mới. Hãy kiểm tra trình duyệt và tắt chức năng chặn popup trên trang controller này.',
		XmlError		: 'Không thể nạp hồi đáp XML từ máy chủ controller.',
		XmlEmpty		: 'Không thể nạp hồi đáp XML từ máy chủ controller. Dữ liệu rỗng.',
