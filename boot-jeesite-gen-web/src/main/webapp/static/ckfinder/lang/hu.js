...
CKFinder.lang['hu'] =
{
	...
	ErrorMsg :
	{
		...
		XmlError		: 'It was not possible to properly load the XML response from the controller server.', // MISSING
		XmlEmpty		: 'It was not possible to load the XML response from the controller server. The server returned an empty response.', // MISSING
