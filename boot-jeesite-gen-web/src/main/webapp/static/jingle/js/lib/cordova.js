 ...
 *
 * onDOMContentLoaded*         Internal event that is received when the controller page is loaded and parsed.
...
// DOM event that is received when the controller page is loaded and parsed.
...
* @param {Array.<ContactField>} urls contact's controller sites
*/
...
module.exports = {
  ...
  /**
   * Clear controller history in this controller view.
   * Instead of BACK button loading the previous controller page, it will exit the app.
   */
