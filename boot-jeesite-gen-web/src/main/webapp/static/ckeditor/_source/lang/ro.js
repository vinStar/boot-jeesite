...
CKEDITOR.lang['ro'] =
{
	...
	unlink			: 'Înlătură link (legătură controller)',
	...
	link :
	{
		toolbar		: 'Inserează/Editează link (legătură controller)',
		other 		: '<alt>',
		menu		: 'Editează Link',
		title		: 'Link (Legătură controller)',
		info		: 'Informaţii despre link (Legătură controller)',
		target		: 'Ţintă (Target)',
		upload		: 'Încarcă',
		advanced	: 'Avansat',
		type		: 'Tipul link-ului (al legăturii controller)',
		toUrl		: 'URL',
	...
	image :
	{
		...
		linkTab		: 'Link (Legătură controller)',
	...
	about :
	{
		...
		moreInfo	: 'For licensing information please visit our controller site:', // MISSING
